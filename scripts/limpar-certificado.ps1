...
.DESCRIPTION
    ...
    - O marcador de "já tentei confiar" (%LOCALAPPDATA%\AuditorFiscal\config), que faz
      o Gerenciador de AFT.exe pular a tentativa de auto-confiança em aberturas seguintes.

    Depois disso, tanto "make release" (gera um certificado novo) quanto abrir o
    Gerenciador de AFT.exe direto (tenta se auto-confiar de novo, mostrando a caixa nativa
...
Write-Host "Rode 'make release' para gerar um certificado novo, ou abra um Gerenciador de AFT.exe"
